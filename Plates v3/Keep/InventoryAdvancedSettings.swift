...
//
//class InventoryAdvancedSettings: UIViewController, UIPopoverPresentationControllerDelegate, FZAccordionTableViewDelegate, UITextFieldDelegate {
...
////                self.currentPlates += [GlobalVariables.sharedInstance.platesList[0...8]]
////            }
////            else {
////                self.currentInventoryUnits += ["lbs"]
////                self.currentInventoryUnitsFormatter += [MassFormatter.Unit.pound]
////                self.currentPlates += [GlobalVariables.sharedInstance.platesLBS[9...17]]
////            }
////                            self.currentInventoryUnits += ["both"]
//            self.currentPlates += [GlobalVariables.sharedInstance.platesList]
//            self.currentInventoryValues += [[6,8,4,4,4,4,4,2,2,6,8,4,4,4,4,4,2,2]]
...
//        navigationController?.navigationBar.titleTextAttributes = [NSAttributedStringKey.foregroundColor: GlobalVariables.sharedInstance.secondaryTextColor, NSAttributedStringKey.font: GlobalVariables.sharedInstance.fontTitle!]
...
//                        currentPlates.insert(GlobalVariables.sharedInstance.platesList, at: 0)
////                    currentPlates += [GlobalVariables.sharedInstance.platesList]
////                    }
////                    else {
...
////            currentInventoryUnits[section] = "both"
////            currentInventoryUnitsFormatter[section] = MassFormatter.Unit.pound
////            currentPlates[section] = GlobalVariables.sharedInstance.platesLBS
//        }
//
...
//            return (GlobalVariables.sharedInstance.currentInventoryList[currentInventoryNames[0]]?.count)! + 2
//    }
//
...
//        header.headerLabel.font = app.visuals.fontStandard
//        header.headerLabel.textColor = app.visuals.defaultTextColor
...
//        var rowCountPerSection = (GlobalVariables.sharedInstance.currentInventoryList[currentInventoryNames[0]]?.count)! + 2
...
//            cell.titleTextField.font = app.visuals.fontStandard
//            cell.leftLabel.font = app.visuals.fontStandard
//            cell.leftLabel.textColor = app.visuals.defaultTextColor
//            cell.titleTextField.textColor = app.visuals.defaultTextColor
//            cell.titleTextField.placeholderFont = app.visuals.fontStandard
...
//        }
//        else if row == rowCountPerSection - 1 {
//            cell.contentView.addSubview(cell.removeButton)
//            cell.removeButton.titleLabel?.font = app.visuals.fontStandard
...
//            }
//            if index < 9 {
//                cell.leftLabel.text = PublicClasses.massFormatter.string(fromValue: GlobalVariables.sharedInstance.platesList[index], unit: MassFormatter.Unit.kilogram)
//            }
//            else {
//                let tempIndex = index - 9
//                cell.leftLabel.text = PublicClasses.massFormatter.string(fromValue: GlobalVariables.sharedInstance.platesList[tempIndex], unit: MassFormatter.Unit.pound)
//            }
...
//            cell.leftLabel.adjustsFontSizeToFitWidth = true
//            cell.leftLabel.textAlignment = NSTextAlignment.left
//            cell.plateCountLabel.font = app.visuals.fontStandard
//            cell.plateCountLabel.textColor = app.visuals.defaultTextColor
